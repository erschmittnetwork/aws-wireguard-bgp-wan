...
% Title Metadata
% -----------------------------
\title{AWS WireGuard BGP WAN with Automated HA Hub Failover \\[6pt]
\large Version 1.0}
\author{Eric Schmitt}
\date{\today}
...
\hline
Date of Issue & February 07, 2026 \\
\hline
...
\hline
1.1 & 2025-12-14 & Technical corrections, validation alignment, and terminology precision & Eric Schmitt \\
\hline
1.2 & 2026-25-01 & Raw data review and LaTeX formatting overhaul & Eric Schmitt \\
\hline
\end{tabular}
...
\texttt{dist/diagrams/logical-architecture.png}, and the document embeds the PNG so that both
HTML and PDF outputs are consistent and deterministic.
\end{quote}

\begin{figure}[!htbp]
\centering
\includegraphics[width=0.75\linewidth]{diagrams/logical-architecture.png}
