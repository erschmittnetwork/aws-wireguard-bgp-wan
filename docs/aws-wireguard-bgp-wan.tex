...
\title{AWS WireGuard BGP WAN with Automated HA Hub Failover\\[0.3em]\normalsize Version 1.3}
\author{Eric Schmitt}
\date{\small \today\ — © 2026 Eric Schmitt. All rights reserved. Portfolio material for demonstration purposes only.}
